<script lang="ts">
	import '../app.css';
	import { SiModrinth, SiGithub, SiDiscord } from '@icons-pack/svelte-simple-icons';
...
<div class="flex h-full w-full flex-col items-center">
	<header class="flex w-full flex-col items-center">
		<div class="max-w-page flex w-full flex-row justify-between gap-4 p-4">
			...
			<span class="flex flex-row items-center gap-6">
				<a aria-label="AxolotlClient on Modrinth" href="https://modrinth.com/mod/axolotlclient">
					<SiModrinth />
				</a>
				<a aria-label="AxolotlClient on GitHub" href="https://github.com/AxolotlClient/">
					<SiGithub />
				</a>
				<a aria-label="AxolotlClient on Discord" href="https://discord.gg/WyMjeX3vka">
					<SiDiscord />
				</a>
			</span>
		</div>
	...
	<footer class="flex w-full flex-col items-center bg-neutral-50 dark:bg-neutral-900">
		<div class="max-w-page flex w-full flex-col gap-4 px-4 py-8">
			...
			<span class="flex flex-row items-center gap-4 select-none">
				<a aria-label="AxolotlClient on Modrinth" href="https://modrinth.com/mod/axolotlclient">
					<SiModrinth size={20} />
				</a>
				<a aria-label="AxolotlClient on GitHub" href="https://github.com/AxolotlClient/">
